        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-10">
          <div className="md:col-span-1">
            ...
            <p className="text-sm leading-relaxed mb-6">
              Premium real estate services across Nigeria. Helping you find your
            ...
            <div className="flex items-center gap-3">
              {socials.map(({ label, href, icon }) => (
                <a
                  ...
                  aria-label={label}
                  className="w-8 h-8 rounded-lg bg-gray-800 hover:bg-[var(--primary)] flex items-center justify-center text-gray-400 hover:text-white transition-colors"
                >
                  {icon}
                </a>
              ))}
          ...
          <div>
            ...
            <div className="rounded-xl overflow-hidden border border-gray-700">
              <iframe
                src="https://www.openstreetmap.org/export/embed.html?bbox=3.3771%2C6.5048%2C3.3812%2C6.5068&layer=mapnik&marker=6.505843%2C3.379166"
                width="100%"
                height="160"
                style={{ border: 0 }}
                loading="lazy"
                title="J.ola Toriola Real Estate Agency location"
              />
            </div>
